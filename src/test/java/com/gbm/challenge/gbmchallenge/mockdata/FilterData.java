...
public class FilterData {
    ...
    protected static Predicate<TransactionDetailEntity> getTransactionDetailsByTransactionId(final String transactionId) {
        return tde -> tde.getTransaction().getTransactionId().equals(transactionId);
    }
